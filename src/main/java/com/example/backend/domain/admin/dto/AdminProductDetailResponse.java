...
import com.example.backend.domain.product.dto.ProductDetailImageResponse;
import com.example.backend.domain.product.dto.ProductVariantResponse;
import com.example.backend.domain.seller.dto.SellerShortResponse;
